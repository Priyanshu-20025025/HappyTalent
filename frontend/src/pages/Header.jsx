    ...
    <header className="bg-white shadow-md py-6 md:py-4 relative z-10"> {/* Added 'relative' and 'z-10' to header */}
      <div className="container mx-auto px-6 md:px-4 flex justify-between items-center">
        <Link href="#" className="flex items-center">
          <Link to={"/"}><img src={logo} alt="Happy Talent Foundation Logo" className="h-20 mr-3" /></Link>
        ...
        <nav className="hidden md:flex space-x-8 items-center">
          ...
          <Link to="/login" className="bg-orange-500 hover:bg-orange-600 text-white py-2.5 px-5 rounded-full transition-colors duration-200 shadow-sm hover:shadow-md font-medium">Log In</Link>
        </nav>
