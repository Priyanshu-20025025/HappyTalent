  ...
  return (
    <section id="hero" className="relative py-24 md:py-36 bg-orange-50"> {/* Default Tailwind Orange */}
      ...
      <div className="container mx-auto px-4 relative text-center">
        ...
        <a href="#courses" className="inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-full transition-colors duration-200 shadow-md hover:shadow-lg"> {/* Default Tailwind Orange */}
          Explore Courses
